...
- Default starting values are GH₵4.00 base + GH₵1.50/km + GH₵0.10/route minute, GH₵10 minimum, no maximum delivery distance, a `2.00x` delivery multiplier, traffic sensitivity `0.60`, and traffic cap `1.25x`. All can be changed from `/admin`.
