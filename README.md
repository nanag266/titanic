...
- Default starting values are GH₵4.00 base + GH₵1.50/km + GH₵0.10/route minute, GH₵10 minimum, no maximum delivery distance, traffic sensitivity `0.60`, traffic cap `1.25x`, and demand/weather multiplier `1.00x`. All can be changed from `/admin`.
